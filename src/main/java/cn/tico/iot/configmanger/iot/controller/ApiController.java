...
public class ApiController implements AdminKey {
	...
	static final String GRAPH_DEVICE="query{device(sno:\"${sno}\") {id,sno,order_time,quality,discard_time,asset_status,alert_status,i18n,cn_name,en_name,price,gateway{id,i18n,cn_name,en_name,env,sno,git_path,desription,subgateway{id,ext_sno,sno,ext_ip},i18n,env,dept{id,dept_name,order_num,leader,phone,email},tags{i18n,cn_name,en_name},kind{i18n,cn_name,en_name},location{i18n,cn_name,en_name}},env,tags{id,i18n,cn_name,en_name,dept{id,dept_name}},kinds{id,i18n,cn_name,en_name,level,order_num},locations{id,i18n,cn_name,en_name,level,order_num},dept{id,dept_name,order_num,leader,phone,email},persons{id,i18n,cn_name,en_name},driver{id,i18n,cn_name,en_name,path,normals{id,i18n,cn_name,en_name,operate_key,unit,order_num,grades{id,i18n,cn_name,en_name,grade,order_num,rules{id，i18n,cn_name,en_name,logic,normal_id,normal{id,i18n,cn_name,en_nameoperate_key,unit},symble,val}}}}}}";
