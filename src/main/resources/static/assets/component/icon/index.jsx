(function (w) {
	...
	function MyIcon(props) {
		let { help = false, iconKey = "LikeOutlined ", placement = "top", text = "强", click, _props = {} } = props;
		...
		return (<div className="my-icon-component-box">
			<div className="test-less-import">
				您好像没引入less文件那
			</div>
			<div className="my-icon-component-content">
				<Tooltip {..._props} onClick={click ? click : function () { console.log('不是一个函数') }} placement={placement} title={text}>
					<ShowIcon {..._props} />
				</Tooltip>
			</div>
		</div>)
